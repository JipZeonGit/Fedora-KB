...
- 🛡️ **用户态优先**: 推荐非 root 用户级安全安装，拒绝破坏系统底层。
...
*告别 GNOME“毛坯房”*
- [01-gnome-extensions.md](./03-Desktop-Environment/01-gnome-extensions.md) — GNOME 界面美化与控制优化 (开启窗口右上角**最小化/最大化按钮**、gsettings 命令行免 GUI 设置、快捷键技巧 `Super+↓/↑`、Dash to Dock 常驻栏)


### 📦 04. 常用软件与 AI 开发工具 (Software & AI Tools)
*常用桌面应用、开发环境与 AI 工具链*
- [01-shell-install-apps.md](./04-Software-Installation/01-shell-install-apps.md) — 常用桌面应用指南 (Steam, MPV, VS Code, Edge, JetBrains Toolbox, 原生微信, WPS Office)
- [02-flatpak-setup.md](./04-Software-Installation/02-flatpak-setup.md) — Flatpak 基础配置
- [03-nodejs-setup.md](./04-Software-Installation/03-nodejs-setup.md) — Node.js 环境管理指南 (`fnm` 用户级管理、镜像加速与 Corepack)
- [04-ai-tools-and-cli.md](./04-Software-Installation/04-ai-tools-and-cli.md) — AI 编程工具与开发 CLI (OpenCode, MimoCode, agy, GitHub CLI, Qoder CN, TRAE CN)
...
- 📝 **文字与文档内容**: 采用 [CC-BY-4.0 (知识共享 署名 4.0 国际许可协议)](https://creativecommons.org/licenses/by/4.0/deed.zh) 开源。转载与二次创作请注明原作者与出处。*(注：部分摘录自官方文档的文件如 [`03-nodejs-setup.md`](./04-Software-Installation/03-nodejs-setup.md) 版权归原官方所有，不适用于本 CC 许可)*
- 🛠️ **自动化脚本与代码 (`scripts/`)**: 采用 [MIT License](https://opensource.org/licenses/MIT) 开源，允许自由修改与商业分发。
